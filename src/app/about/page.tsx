const About: React.FC = () => {
  return (
    <main className=' w-8/12 justify-between p-32 text-slate-800'>
      ...
      <p>
        ...
        home. We&apos;re committed to providing you with the finest selection of houseplants, expert
        care tips, and the tools you need to nurture your indoor garden.
      </p>
      ...
      <ul className='list-disc'>
        ...
        <li>
          <b>Sustainability:</b> We care about the environment and strive to be eco-conscious in all
          our practices, from packaging to sourcing.
        </li>
        <li>
