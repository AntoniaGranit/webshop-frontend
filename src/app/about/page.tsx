const About: React.FC = () => {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <p>LeafLife sprouted from a shared love for plants among a group of friends who believed that everyone should have access to lush, vibrant greenery in their homes. Inspired by our own experiences with houseplants and the positive impact they&apos;ve had on our lives, we set out to create a place where plant lovers can find everything they need.</p>
